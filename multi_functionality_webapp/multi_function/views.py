...
from .serializers import PastPatientDetailSerial, UserRegisterationSerial, UserLoginSerial, UserProfileSerial, ChangePasswordSeial, SendPasswordResetMailSerial,UserPasswordResetSerial, ContactSerial,QuestionSerial,RandomQuestionSerial,QuizSerial,PatientAppointmentSerial,DoctorSerial,PatientSerialView
